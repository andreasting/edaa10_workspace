...
public class NumberGenerator {
	...
	// om max är 100 och min 10 blir det 100-10 = 90 , om talet blir noll (minst det blir) så läggs tian på, så den blir vår lägsta tal. Om max-mon blir hösta talet läggs min tillbaks
	...
	// Fråga om det är bättre att skriva return this.secretNbr<guess;
